...
class Matching extends Component {
  ...
  componentDidMount() {
    ...
    if (
      currProccessedXray.prediction === "normaltoslight" ||
      currProccessedXray.prediction === "normal"
    ) {
      Aiprediction = 1;
  ...
  render() {
    console.log( this.props.eval.Xrays[this.props.ActiveTypeIndex].xrays[this.props.ActiveXrayIndex].up)
    return (
      <div>
        <div id="Evaluaion_XrayMatching_Matching_Content1_Wrapper">
          ...
          <div id="Evaluaion_XrayMatching_Matching_Heading2_Div">
            Confirm the levels of degeneration by clicking on the other levels
            and matching your X-ray to the comparison X-ray.
          </div>
          {[
        ...
        <div id="Evaluaion_XrayMatching_Matching_Content2_Wrapper">
          ...
          <div className="Evaluaion_XrayMatching_Matching_Xray_Image_Wrapper">
            ...
            <img alt="Patient Xray" className="Evaluaion_XrayMatching_Matching_Xray_Image" src={this.props.eval.Xrays[this.props.ActiveTypeIndex].xrays[this.props.ActiveXrayIndex].up}/>
