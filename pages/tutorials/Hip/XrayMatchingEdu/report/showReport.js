...
class ShowReport extends Component {
  ...
  handleNextClick = () => {
    ...
    this.context.history.push("/tutorials/hip-matching-education/completed");
  };
                    ...
                    <React.Fragment>
                      <Grid item xs={12} style={{ height: "100%" }}>
                        <div className="Evaluaion_Report_Box_Text5">
                          {type.name} <br /> {type.name !== "Kneecap" && "View"}
                        </div>
                      </Grid>
                    </React.Fragment>
                  </Grid>
                  <Grid container item xs={9} spacing={0}>
                    {type.xrays.map((xray, id) => (
                      <React.Fragment key={id}>
                        ...
                        >
                          <div className="Evaluaion_Report_Box_Button_Div2">
                            {/* <Button
