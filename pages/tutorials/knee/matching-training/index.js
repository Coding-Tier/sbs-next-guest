  ...
  render() {
    return (
      <Router history={this.context.history}>
        <Route
          exact
          path="/tutorials/matching-training/"
          render={() => <Redirect to="./matching-education/welcome" />}
        />
        <Route
          exact
          path="/tutorials/matching-training/welcome"
          component={Welcome}
        />
        <Route
          exact
          path="/tutorials/matching-training/matching-tutorial"
          component={MatchingTutorial}
        />
        <Route
          exact
          path="/tutorials/matching-training/congratulations"
