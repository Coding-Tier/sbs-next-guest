...
const NextPage = "/tutorials/knee/short-knee/LATCOTK";
        ...
        <div id="SBSVideo_Center_Wrapper">
          <div id="SBSVideo_Image_Wrapper">
            ...
            <ReactPlayer onReady={this.onVideoReady}
              height='700px'
              width='1000px'
              url='https://vimeo.com/681521006'  controls={true} playing={true} onEnded={this.onVideoEnd} light={this.state.light} />
