        ...
        <div id="Evaluaion_XrayMatching_Matching_Content1_Wrapper">
          ...
          <div style={{ display: 'block', width: '100%' }}>
            ...
            <div className="Evaluaion_XrayMatching_Matching_Confirm_Button_Div" style={{ width: '150px', marginRight: '20px' }} >
              <Button className="Evaluaion_XrayMatching_Matching_Confirm_Button" variant="contained" onClick={() => {
                this.context.Navigate("./x-ray-matching-and-levels-of-degeneration");
              }}> Back </Button>
            </div>
