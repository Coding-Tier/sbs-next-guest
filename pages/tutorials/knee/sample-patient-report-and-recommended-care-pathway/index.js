...
const tutorialCompleteId = 9;
class SPRARCP extends Component {
  constructor(props) {
    super(props);
            ...
            <div id="SBSVideo_Image_Wrapper">
              <div className="sbs-video-text-wrapper">
                <div id="SBSVideo_Heading1_Div">
                  Sample Patient Report and Recommended Care Pathway
                </div>
              </div>
              ...
              <ReactPlayer onReady={this.onVideoReady}
                height='700px'
                width='1000px'
                url='https://vimeo.com/508157082' controls={true} playing={true} onEnded={this.onVideoEnd} light={this.state.light}
              />
            </div>
...
SPRARCP.contextType = MyContext;
export default SPRARCP;
