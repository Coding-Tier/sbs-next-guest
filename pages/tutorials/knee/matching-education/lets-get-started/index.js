            ...
            <div id="Evaluaion_Welcome_Main_Div">
                ...
                <div id="Evaluaion_Welcome_Text_Wrapper">
                    <div id="Evaluaion_Welcome_Heading1_Div">
                        <div className='gradient_div'style={{height:'100px',margin:'0px',paddingLeft:'10px'}} >
                            <img 
                            width={"80px"}
                            height={"80px"}
                            alt={"Bulb"} src={Bulb} style={{ width: '80px', height: '80px', margin: '5px' }} />
                            <span className={LGSStyleSheet.test_span}>Test Your Knowledge</span>
                        </div>
                    </div>
                    ...
                    <div id="Evaluaion_Welcome_Text_Div">
                        Review and confirm the AI predictions using X-ray Matching and the comparision X-rays.
                        Do this for each compartment in each view.
                    </div>
                    <div id="Evaluaion_Welcome_Next_Button_Div">
                        <Button id="Evaluaion_Welcome_Next_Button" variant="contained" onClick={() => { this.context.setCookie("tutorial-" + this.context.state.user_id, 35); this.context.Navigate('./matching-tutorial') }}> Continue </Button>
                    </div>
