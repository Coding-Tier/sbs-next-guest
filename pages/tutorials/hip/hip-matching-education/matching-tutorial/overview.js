...
import BoneImage from "../../../../assets/hip/Asset 9RHip.png";
      ...
      <div>
        <div id="Evaluaion_XrayMatching_OverView_Content1_Wrapper">
          ...
          <div id="Evaluaion_XrayMatching_EvalName_Content2_Outer_Wrapper">
            <div
              id="Evaluaion_XrayMatching_EvalName_Content2_Wrapper"
            ...
            >
                ...
                <div className="Evaluaion_PatientProfile_Image_Left_Inner_Up" >
                  <div className="Evaluaion_PatientProfile_Image_Left_Inner_Up_Content1">
                    <TextField
                      ...
                      style={{ width: "115px" }}
                      variant="outlined"
                      inputProps={{ className: "textbox-height" }}
                    />
                  </div>
              ...
              <div id="Evaluaion_XrayMatching_EvalName_Image_Bone_Div">
                {" "}
                <img 
                  style={{transform:"translate(20px, 120px)"}}
                  src={BoneImage}
                  alt="SBS"
                  id="Evaluaion_XrayMatching_EvalName_Image_Bone"
                />
              </div>
            </div>
            ...
            <div
              className="Tutorials_XrayMatchingEducation_Matching_Overview_Wrapper"
            ...
            >
              {this.props.Evaluation.Xrays.map((type, id) => (
                <div key={id}>
                  ...
                  <div
                    key={id}
                    className="Evaluaion_XrayMatching_OverView_Box_Div"
                  >
                    {type.xrays.map((xray, id) => (
                      <div key={id}>
                        <div className="Evaluaion_XrayMatching_OverView_Box1_Content1">
                          <img 
                            className="Evaluaion_XrayMatching_OverView_Box1_Content1_Image"
                            alt={xray.name}
                            src={xray.thumbnail}
                          />
                        </div>
                        <div className="Evaluaion_XrayMatching_OverView_Box1_Content2">
                          {xray.isDone === true ? (
                            <div className="aaaa">
                              <div className="Evaluaion_XrayMatching_OverView_Box_DisbaleText">
                                {" "}
                                {xray.name}{" "}
                                {xray.name == "Kneecap" ? "View" : null}{" "}
                              </div>
                              <div className="Evaluaion_XrayMatching_OverView_Box_DisbaleText2">
                                {" "}
                                <img 
                                  src={Tick}
                                  style={{ width: "16px" }}
                            ...
                            <Button
                              className="Evaluaion_XrayMatching_OverView_Box_Button"
                              variant="contained"
                              onClick={() =>
                                this.props.handleClick(type.name, xray.name)
                              }
                            >
                              {" "}
                              {xray.name}{" "}
          ...
          {this.props.Next && (
            <div id="Evaluaion_XrayMatching_Overview_Next_Button_Div">
              <Button
                id="Evaluaion_XrayMatching_Overview_Next_Button"
                variant="contained"
                onClick={this.props.handleNextClick}
              >
                {" "}
                View X-ray Report Card{" "}
              </Button>
            </div>
          )}
        </div>
