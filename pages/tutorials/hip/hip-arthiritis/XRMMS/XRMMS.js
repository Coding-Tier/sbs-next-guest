...
// import ImageUp from "../../../../assets/HipEducationAssets/patient_comparison_x-ray.png";
// import ImageDown from "../../../assets/imageDown.png";

const ImageUp = "https://firebasestorage.googleapis.com/v0/b/sbs-stag.appspot.com/o/tutorialassets%2Fhip%2FAboutHip%2FXRMMS%2Fpatient_comparison_x-ray.png?alt=media"
      ...
      <div id="XRMMS_Main_Div">
        <div id="Evaluaion_XrayMatching_Matching_Content1_Wrapper">
          ...
          <div id="Evaluaion_XrayMatching_Matching_Heading2_Div">
            Looking at the two images on the right, the top X-ray is a patient’s
            right knee and the bottom X-ray is a comparison X-ray provided by
            the Step by Step database. Both X-rays show a similar amount of
            joint space narrowing, therefore they are a match.
          </div>
          {[
            ...
            >
              <Button
                ...
                style={{
                  background:
                    text.id == "2" ? "#fffb00" : "hsla(0, 0%, 100%, 0.08)",
                }}
                variant="contained"
              >
                {" "}
          ...
          <div style={{ display: "block", width: "100%" }}>
            ...
            <div
              className="Evaluaion_XrayMatching_Matching_Confirm_Button_Div"
            ...
            <div className="Evaluaion_XrayMatching_Matching_Confirm_Button_Div">
              <Button
                ...
                onClick={() => {
                  ...
                  this.context.Navigate("./congrats");
                }}
              >
                {" "}
                Continue{" "}
        ...
        <div id="Evaluaion_XrayMatching_Matching_Content2_Wrapper">
          <div id="Evaluaion_XrayMatching_Matching_Heading3_Div">
            RIGHT HIP - AP PELVIS VIEW <br />
            ZONE 1
          </div>

          <div style={{ maxWidth: "500px", maxHeight: "calc(75% - 30px)" }}>
            <img
