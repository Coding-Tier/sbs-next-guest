    ...
    return (
      <div id="Tutorials_Welcome_Main_Div">
        <div id="Tutorials_Welcome_Text_Wrapper">
          ...
          <div id="Tutorials_Welcome_Heading2_Div">Hip Arthritis Education</div>
          <div id="Tutorials_Welcome_Text_Div">
            Familiarize yourself with the anatomy of the hip and the different
            levels of degeneration. Learn what X-rays are needed to perform a
            complete evaluation for a patient's hip pain.
          </div>
          <div id="Tutorials_Welcome_Next_Button_Div">
            <Button
              ...
              onClick={() => {
                ...
                this.context.Navigate("/tutorials/hip/hip-arthiritis/overview");
              }}
            >
              {" "}
              Continue{" "}
